...
class Agent(BaseModel, AuditMixin):
    ...
    environment = Column(SQLEnum(AgentEnvironment), nullable=False, default=AgentEnvironment.DEVELOPMENT)
...
class AgentCapability(BaseModel):
    ...
    __table_args__ = (
        ...
        # (we need to use a different constraint syntax since this is a declarative model)
    )
